...
//    mrbc.addFileArg(b.path("src/fiber_ping.rb"));
    ...
    const mod = b.addModule("mrubyOnZig", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "mrubyOnZig" is the name you will use in your source code to
                // import this module (e.g. `@import("mrubyOnZig")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "mrubyOnZig", .module = mod },
            },
        }),
    });
